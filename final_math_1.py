...
count = 1 #set the count accumulator to zero
while another == 'y' or another == 'Y':
    ...
    if float(total % count < .5):
        avg = math.floor(total / count)
    elif float(total % count >= .5):
        avg = math.ceil(total / count)
    else:
        print('There is an error in your entries somewhere.  Please try again')
    ...
    if another == 'y' or another == 'Y':
        ...
        print('The average of your scores(rounded) is: ', avg)
